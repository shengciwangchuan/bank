...
LINK       = $(CC) $(VSS_CFLAGS) $(VSS_LDFLAGS) -Wall
...
prepare:
	...
	@echo ""
	@if [ -f  "/home/share/publish/Jenkins/shell/extracheck.sh" ]; then /home/share/publish/Jenkins/shell/extracheck.sh $(MODULE_ROOT);fi
